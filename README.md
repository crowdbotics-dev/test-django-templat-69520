...
## Project Structure
    ...
    ├── test_django_templat_69520  # Django project configurations
...
1. Clone this repo and `cd test_django_templat_69520`
...
2. Clone this repo and `cd test_django_templat_69520`
